...
auth_channel = environ.get('AUTH_CHANNEL', '-1001828828485') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mangolv:uBM0qfRO8YqzlqKH@atlascluster.xj34iki.mongodb.net/?retryWrites=true&w=majority&appName=AtlasCluster")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/hd99flixrequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hd99flix')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Netflix_Amazon_prime_altbalaji/54')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HDSX_Media_xyz') # Support Chat Link Without https:// or @
